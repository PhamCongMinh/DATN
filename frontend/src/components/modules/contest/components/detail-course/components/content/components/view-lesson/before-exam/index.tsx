...
const BeforeExam: React.FC<IProps> = (props): JSX.Element => {
  ...
  const [examSubmit, setExamSubmit] = useState<IExamSubmit>()
  ...
  const handleStartExam = (examSubmit: IExamSubmit) => {
    setExamSubmit(examSubmit)
  ...
  return (
    <div>
      ...
      {examSubmit && <Exam exam_submit={examSubmit} onSubmit={handleSubmitExam} />}
    </div>
  )
}
